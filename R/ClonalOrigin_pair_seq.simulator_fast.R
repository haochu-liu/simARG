#' Simulate approximated ARG using ClonalOrigin with pair method (fast)
#'
...
#' summary_stats <- ClonalOrigin_pair_seq.simulator_fast(tree, 0.5, 0.3, 100L, 5,
#'                                                       2000, c(10L, 20L, 70L))
ClonalOrigin_pair_seq.simulator_fast <- function(tree, rho_site, theta_site,
                                                 L, delta, N,

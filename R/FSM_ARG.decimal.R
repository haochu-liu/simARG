...
#'
#' @examples
#' ARG1 <- FSM_ARG.decimal(20L, 0.1, 100L)
#' ARG2 <- FSM_ARG.decimal(5L, 0.1, 200L, bacteria = TRUE, delta = 10, optimise_recomb = TRUE, clonal = TRUE)
FSM_ARG.decimal <- function(n, rho_site, L, bacteria=FALSE, delta=NULL, node_max=1000,
